	...
	<section class="main">
		<div class="box">
			<div class="review_section">
				<h1>리뷰페이지 수정 페이지</h1>
				<form action="updateReview" method="post" class="form">
					<input type="hidden" name="id" value="${sessionScope.id }">
					<input type="hidden" name="rev_no" value="${rv.rev_no }">
					<table border="1">
						<tr>
							<td>제목</td>
							<td><input type="text" name="rev_title" class="title"
								value="${rv.rev_title }"></td>
						</tr>
						<tr>
							<td>이름</td>
						...
						<tr>
							<td>내용</td>
							<td><textarea name="rev_contents" cols="70" rows="10">${rv.rev_contents }</textarea></td>
						</tr>
						<tr>
							<td>상품평점</td>
							<td>
								<div id="re_star" class="re_box">
									...
									<div class="star_rating">
										...
										<input type="radio" name="rev_rating" id="star1" class="stars"
											value="1" onclick="rating_stars(1)"> <label
											for="star1"></label> <input type="radio" name="rev_rating"
											id="star2" class="stars" value="2" onclick="rating_stars(2)">
										<label for="star2"></label> <input type="radio"
											name="rev_rating" id="star3" class="stars" value="3"
											onclick="rating_stars(3)"> <label for="star3"></label>
										<input type="radio" name="rev_rating" id="star4" class="stars"
											value="4" onclick="rating_stars(4)"> <label
											for="star4"></label> <input type="radio" name="rev_rating"
											id="star5" class="stars" value="5" onclick="rating_stars(5)">
										<label for="star5"></label> <input type="hidden"
											name="star_val" id="star_val" value="">
									</div>
								</div>
							</td>
						</tr>
						<tr>
							<td colspan="2"><input type="submit" value="수정하기"> <input
								...
								onclick="location.href='deleteReview?rev_no=${rv.rev_no}'"></td>
